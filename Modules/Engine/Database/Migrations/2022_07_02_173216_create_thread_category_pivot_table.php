...
return new class extends Migration
{
    ...
    public function up()
    {
      ...
      if(!Schema::hasTable($tableNames['thread_category'])) {
      Schema::create($tableNames['thread_category'], function (Blueprint $table) {
          $table->foreignId('thread_id')->constrained(config('db.table_names.threads'))->onDelete('cascade')->nullable();
          $table->foreignId('category_id')->constrained(config('db.table_names.categories'))->onDelete('cascade')->nullable();
    ...
    public function down()
    {
      ...
      Schema::dropIfExists($tableNames['thread_category']);
    }
};
